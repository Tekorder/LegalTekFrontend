/* ═══════════════════════════════════════════════
   LegalTek AI — app.jsx
   Root component: App + mount
   Depends on: utils.jsx, components/*.jsx
═══════════════════════════════════════════════ */

const { useState, useRef, useEffect, useCallback } = React;

const {
  apiFetch, apiPost, apiUpload,
...
/* ══════════════════════════════════════════════════════
   ROOT APP
══════════════════════════════════════════════════════ */
function App({ user, initialCase, onBackToCases }) {
  /* ── Case state ── */
...
/* ══════════════════════════════════════════════════════
   ...
   Flow: index.html loads Firebase SDK → firebase-config.js →
         utils + LoginPage.jsx → app.jsx (this file).
══════════════════════════════════════════════════════ */
function Root() {
  ...
  if (!user) {
    return LoginPage ? <LoginPage /> : (
      <div className="h-full w-full animated-bg flex items-center justify-center text-red-600 text-sm px-6 text-center">
        LoginPage not loaded. Check index.html script order (components/LoginPage.jsx before app.jsx).
      </div>
    );
  }
  ...
  return <App user={user} initialCase={selectedCase} onBackToCases={() => setSelectedCase(null)} />;
}
